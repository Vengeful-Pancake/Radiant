...
def camera():
    ...
    while True:
        ...
        # detect the countours
        countors, _ = cv2.findContours(fgmask1, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
        ...
        forground = cv2.bitwise_and(frame,frame , mask = fgmask1)
        stacked = np.hstack((frame0,forground,frameCopy))
